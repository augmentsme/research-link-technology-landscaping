...
class ClusteringManager:
    ...
    def cluster_keywords(self) -> List[KeywordCluster]:
        ...
        clustering_path = CONFIG.chromadb_path / "clustering.json"
    ...
    def run_full_pipeline(
        self,
        output_file: Union[str, Path] = CONFIG.clusters_proposal_path
    ) -> List[KeywordCluster]:
        """
...
def clear_all_cache() -> None:
    ...
    """
    from database import EmbeddingManager
...
# Clustering and harmonization functionality has been integrated into the unified CLI (cli.py)
# Use: python cli.py cluster --help


def perform_keyword_clustering(output_file: str, similarity_threshold: float, min_cluster_size: int, force_regenerate: bool = False):
    """Perform keyword clustering - wrapper function for CLI."""
...
def create_keyword_mapping(clusters_file: str, keywords_file: str, output_file: str):
    """Create keyword mapping - wrapper function for CLI."""
    import json
...
def clear_clustering_cache():
    """Clear clustering cache - wrapper function for CLI."""
    clear_all_cache()
