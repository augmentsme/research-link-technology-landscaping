...
class GrantFilterManager:
    ...
    def apply_filters(self, config: GrantFilterConfig) -> pd.DataFrame:
...
class SidebarControls:
    ...
    def render_sidebar(self) -> Tuple[GrantFilterConfig, int]:
    ...
    def _render_filtering_options(self) -> GrantFilterConfig:
    ...
    def _show_active_filters(self, config: GrantFilterConfig):
...
class GrantDistributionVisualizer:
    ...
    def render_tab(self, filter_config: GrantFilterConfig, max_funders: int):
    ...
    def _generate_visualization(self, filter_config: GrantFilterConfig, max_funders: int):
    ...
    def _create_grants_visualization(self, grants_by_year_funder: pd.DataFrame, filter_config: GrantFilterConfig, max_funders: int) -> go.Figure:
    ...
    def _create_chart_title(self, filter_config: GrantFilterConfig) -> str:
        """Create title with filter information"""
...
class GrantsPage:
    ...
    def run(self):
        ...
        with tab2:
            ...
            display_df, config = DataExplorerPreparation.prepare_grants_data(self.grants_df)
